...
Route::prefix('pasien')->name('pasien.')->middleware(['auth', 'role:pasien'])->group(function () {
    ...
    // AJAX: jadwal by dokter (untuk dropdown dinamis di form reservasi)
    Route::get('/reservasi/jadwal',    [ReservasiController::class, 'getJadwalByDokter'])->name('reservasi.jadwal');
    ...
    // Rekam Medis (pasien hanya bisa lihat)
...
// ==================== LEGACY DASHBOARD ROUTES (redirect) ====================
Route::prefix('dashboard')->name('dashboard.')->middleware('auth')->group(function () {
    Route::get('/admin',  fn() => redirect()->route('admin.dashboard'))->name('admin');
    Route::get('/dokter', fn() => redirect()->route('dokter.dashboard'))->name('dokter');
    Route::get('/pasien', fn() => redirect()->route('pasien.dashboard'))->name('pasien');
});
