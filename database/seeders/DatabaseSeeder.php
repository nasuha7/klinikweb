...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $dokterData = [
            [
                'name'          => 'Andi Wijaya',
                'email'         => 'andi.dokter@klinik.com',
                'spesialis'     => 'Sp.PD - Penyakit Dalam',
                'no_str'        => 'STR-001-2024',
                'jenis_kelamin' => 'L',
            ],
            [
                'name'          => 'Siti Rahma',
                'email'         => 'siti.dokter@klinik.com',
                'spesialis'     => 'Sp.A - Spesialis Anak',
                'no_str'        => 'STR-002-2024',
                'jenis_kelamin' => 'P',
            ],
            [
                ...
                'spesialis'     => 'Sp.JP - Spesialis Jantung',
                'no_str'        => 'STR-003-2024',
                'jenis_kelamin' => 'L',
            ],
        ];
        ...
        foreach ($dokterData as $data) {
            ...
            for ($i = 0; $i < 7; $i++) {
                ...
                // Skip minggu
                if ($tanggal->dayOfWeek === 0) continue;
